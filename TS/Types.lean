...
:::::exercise (rating := 3) (name := "step_deterministic") (optional := Yes)
...
:::::exercise (rating := 1) (name := "succ_hastype_nat__hastype_nat") (optional := Yes)
```lean
...
:::::exercise (rating := 3) (name := "finish_progress_informal") (optional := Yes)
...
:::::exercise (rating := 3) (name := "finish_preservation_informal") (optional := Yes)
...
:::::exercise (rating := 2) (name := "variation3") (optional := Yes)
...
:::::exercise (rating := 2) (name := "variation4") (optional := Yes)
Suppose instead that we add this rule:
```
...
:::::exercise (rating := 2) (name := "variation5") (optional := Yes)
Suppose instead that we add this rule:
```
funny4 : ⊢ 0 ⦂ Bool
```
...
:::::exercise (rating := 2) (name := "variation6") (optional := Yes)
Suppose instead that we add this rule:
```
funny5 : ⊢ pred 0 ⦂ Bool
```
...
:::::exercise (rating := 3) (name := "more_variations") (optional := Yes)
