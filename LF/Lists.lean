...
:::::exercise (rating := 1) (name := "fst_swap_is_snd") (optional := Yes)
```lean
...
:::::exercise (rating := 3) (name := "removing") (optional := Yes)
...
:::::exercise (rating := 3) (name := "included") (optional := Yes)
```lean
...
:::::exercise (rating := 3) (name := "count_append") (optional := Yes) (manual := true)
...
:::::exercise (rating := 1) (name := "option_elim_head?") (optional := Yes)
