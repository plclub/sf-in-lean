...
::::::full
:::::exercise (rating := 2) (name := "mumble_grumble") (optional := Yes) (manual := true)
...
:::::exercise (rating := 1) (name := "zip_checks") (optional := Yes)
...
::::::full
:::::exercise (rating := 1) (name := "head?_poly") (optional := Yes)
...
::::::full
:::::exercise (rating := 2) (name := "implicit_args") (optional := Yes)
...
::::::full
:::::exercise (rating := 1) (name := "fold_types_different") (optional := Yes) (manual := true)
...
:::::exercise (rating := 2) (name := "nth_error_informal") (level := Advanced) (optional := Yes) (manual := true)
