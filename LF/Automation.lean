    ...
    | cons h s₁' =>
      solution!
        ...
        have hcases : (List.length (h :: s₁') < re.pumpingConstant
                      ∨ re.pumpingConstant ≤ List.length (h :: s₁')) := by
          lia
        cases hcases with
        | inl =>
          left; constructor
