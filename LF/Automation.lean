...
::::exercise (rating := 1) (name := "EmptyStr_not_needed") (optional := Yes)
...
::::exercise (rating := 1) (name := "exp_match_ex2") (optional := Yes)
...
::::exercise (rating := 2) (name := "weak_pumping_star_zero") (optional := Yes)
```lean
...
::::exercise (rating := 5) (name := "weak_pumping_star_app") (optional := Yes)
```lean
...
::::exercise (rating := 5) (name := "weak_pumping") (optional := Yes)
