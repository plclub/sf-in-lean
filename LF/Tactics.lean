...
:::::exercise (rating := 2) (name := "apply_exercise") (optional := Yes)
...
:::::exercise (rating := 1) (name := "apply_rewrite") (optional := Yes) (manual := true)
...
:::::exercise (rating := 3) (name := "trans_eq_exercise") (optional := Yes)
```lean
...
:::::exercise (rating := 3) (name := "length_append_cons") (optional := Yes)
...
:::::exercise (rating := 3) (name := "length_append_self") (optional := Yes)
...
:::::exercise (rating := 3) (name := "diagonal_induction") (optional := Yes)
