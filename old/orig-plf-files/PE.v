...
(* LATER: FOLD some proofs! *)
(** The \CHAP{Equiv} chapter introduced constant folding as an example of a
...
(* SOONER: Also defined in Norm.v -- it's a shame to do it in two places! *)
...
[[
    ...
    the notation used in \CHAP{Imp}; perhaps this should be changed!)
*)
(* SOONER: The syntax for the maps at the beginning and end is not
   consistent with the current notation in Maps.v *)
...
(* SOONER: beq_nat_refl should be replaced by something more up to date *)
